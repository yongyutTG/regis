...
<h4 class="modal-title" id="exampleModalLabel"><b>ลบข้อมูลผู้ช่วยดูแลระบบ</b></h4>
	...
	<div class="modal-body">
			...
			<div class="mb-3">
				...
				<input type="text"  name="upass" class="form-control" value="<?php echo $row['upass']?>">
					...
					<button type="submit" class="btn btn-outline-danger"><img src="../../../images/del.png" width="24"> ลบ</button>
					</div>
				</form>
	</div>
