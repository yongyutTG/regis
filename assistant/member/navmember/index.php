...
$name=$_SESSION['name'];
  ...
  echo "<script>window.location='../../logout/'</script>";
    ...
    $resultmember=$object->Member();
?>

<nav class="navbar navbar-expand-lg navbar-light bg-success">
<a class="navbar-brand" href="#" style="font-size: 16px;padding: 0px 6px 0px 12px;color: white;"><b>DashBoard<br>Assistant Admin : <?php echo $_SESSION['name'] ?></b></a>
